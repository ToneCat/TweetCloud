...
const twitClient = new Twitter({
    ...
    app.get('/search/:keyword', (request, response) => {
        ...
        let keyword3 = (/\b(de|el|;|so|to|y|en|la|-|:|&amp;|ー|—|e|-|ー|..)\b/);
        ...
        twitClient.get("search/tweets", {q: keyword, count: 100})
        .then(tweets1 => {
            ...
            twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id})
            .then(tweets2 => {
                ...
                twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id2})
                    .then(tweets3 => {
                    ...
                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id3})
                    .then(tweets4 => {
                    ...
                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id4})
                    .then(tweets5 => {
                    ...
                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id5})
                    .then(tweets6 => {
                    ...
                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id6})
                    .then(tweets7 => {
                    Array.prototype.push.apply(tweetStack,tweets6.data.statuses)
                    var last_id7 = tweets7.data.statuses[tweets7.data.statuses.length-1].id_str;

                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id7})
                    .then(tweets8 => {
                    ...
                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id8})
                    .then(tweets9 => {
                    ...
                    twitClient.get("search/tweets", {q: keyword, count: 100, max_id: last_id9})
                    .then(tweets10 => {
                    ...
                    for(var i = 0; i <= tweetStack.length-1; i++) {
                     ...
                     let rejectFo3 = arrayfilter.patternReject(keyword3)
                     ...
                     let wordsToArray4 = wordsToArray3.filter(rejectFo3); // filters out useless characters and some spanish/foreign words
                     let wordsToArray = wordsToArray4.filter(rejectEmpty); // removes null entries
        ...
        /*twitClient
            ...
            .then(tweets => {
                ...
                for(var i = 0; i <= tweets.data.statuses.length-1; i++) {
                 ...
                 let wordsToArray2 = wordsToArray1.filter(rejectFo); // removes instance of keyword
                 let wordsToArray3 = wordsToArray2.filter(rejectFo2); // removes lowercase instance of keyword
                 let wordsToArray4 = wordsToArray3.filter(rejectFo3); // filters out useless characters and spanish/foreign words
                 let wordsToArray = wordsToArray4.filter(rejectEmpty); // removes null entries
    ...
    app.get('/user/:username', (request, response) => {
        ...
        twitClient.get("statuses/user_timeline", {screen_name: username, count: 100}, function(err, data1, response) {
            console.log(data1)
         
            var last_id = data1[data1.length-1].id_str;
            console.log(last_id)
           
            twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id}, function(err, data2, response) {
                console.log(data2)
                Array.prototype.push.apply(data1,data2)
                var last_id2 = data2[data2.length-1].id_str;
             
                twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id2}, function(err, data3, response) {
                    console.log(data3)
                    Array.prototype.push.apply(data1,data3);
                    var last_id3 = data3[data3.length-1].id_str;
                    
                    twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id3}, function(err, data4, response) {
                        console.log(data4)
                        var last_id4 = data4[data4.length-1].id_str;
                        Array.prototype.push.apply(data1,data4);

                        twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id4}, function(err, data5, response) {
                            console.log(data5)
                            var last_id5 = data5[data5.length-1].id_str;
                            Array.prototype.push.apply(data1,data5);

                            twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id5}, function(err, data6, response) {
                                console.log(data6)
                                var last_id6 = data6[data6.length-1].id_str;
                                Array.prototype.push.apply(data1,data6);
                               
                                twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id6}, function(err, data7, response) {
                                    var last_id7 = data7[data7.length-1].id_str;
                                    Array.prototype.push.apply(data1,data7);

                                    twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id7}, function(err, data8, response) {
                                        var last_id8 = data8[data8.length-1].id_str;
                                        Array.prototype.push.apply(data1,data8);

                                        twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id8}, function(err, data9, response) {
                                            var last_id9 = data9[data9.length-1].id_str;
                                            Array.prototype.push.apply(data1,data9);

                                            twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id9}, function(err, data10, response) {
                                                var last_id10 = data10[data10.length-1].id_str;
                                                Array.prototype.push.apply(data1,data10);

                                                twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id10}, function(err, data11, response) {
                                                    var last_id11 = data11[data11.length-1].id_str;
                                                    Array.prototype.push.apply(data1,data11);

                                                    twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id11}, function(err, data12, response) {
                                                        var last_id12 = data12[data12.length-1].id_str;
                                                        Array.prototype.push.apply(data1,data12);

                                                        twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id12}, function(err, data13, response) {
                                                            var last_id13 = data13[data13.length-1].id_str;
                                                            Array.prototype.push.apply(data1,data13);

                                                            twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id13}, function(err, data14, response) {
                                                                var last_id14 = data14[data14.length-1].id_str;
                                                                Array.prototype.push.apply(data1,data14);

                                                                twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id14}, function(err, data15, response) {
                                                                    var last_id15 = data15[data15.length-1].id_str;
                                                                    Array.prototype.push.apply(data1,data15);

                                                                    twitClient.get("statuses/user_timeline", {screen_name: username, count: 100, max_id: last_id15}, function(err, data16, response) {
